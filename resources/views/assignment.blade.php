<x-app-layout>
    ...
    <div class="wrapper relative"> 
        <div id="assignment-title" class="rounded-lg font-black p-2 px-5 drop-shadow-xl top-5 absolute bg-white show z-10 hidden">
            {{-- load javascript --}}
        </div>
        <div id="timer" class="rounded-lg font-black p-2 px-5 drop-shadow-xl top-5 right-10 absolute bg-white show z-10 hidden">
            {{-- load javascript --}}
        </div>
                    ...
                    <form action="#">
                        <div class="relative mb-5">
                            <label for="super_concept" class="block mb-2 font-bold text-left mb-5 leading-tight text-md text-gray-900 dark:text-white">
                                Assignment Keycode <br>
                                <small class="text-gray-400">e.g KZE-IUP-LOD</small>
                            </label>
                            <input type="text" id="ckey" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter keycode" required>
                        </div>
...
<script>
    ...
    btnSidenav.addEventListener('click', function() {
        ...
        assignmentTitleEl.classList.toggle('hide')
