...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Scripts -->
        @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/gojs.js'])
        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="w-11/12 max-w-7xl mx-auto lg:px-8">
                ...
                <div class="flex justify-center mt-16">
                    <h1 class="text-5xl mx-auto font-extrabold tracking-tight leading-none text-center dark:text-white" style="font-family: 'Mona Sans'">
                        Open CMAP-Tools for assignment<br>build with <span class="text-red-600">Laravel</span> and <span class="text-blue-600">GoJS</span>
                    </h1>
                </div>

                <div class="mt-16">
                    <div id="board" class="w-full" style="height: 32rem;">

                    </div>
                </div>

                <div class="mt-16">
                    <h1 class="mb-4 font-extrabold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600" style="font-family: 'Mona Sans'">
                ...
                <div class="mt-16">
                    <h1 class="font-extrabold text-center mx-auto text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-blue-600" style="font-family: 'Mona Sans'">
                        Why use Open-CMAP
                    </h1>

                    <div id="scrolling-container" class="flex items-center mt-8 bg-black rounded-lg shadow-lg" style="height: 800px;">
                ...
                <div class="mt-16">
                    <h1 class="font-extrabold text-right mx-auto text-transparent text-6xl bg-clip-text bg-gradient-to-r from-purple-400 to-blue-600" style="font-family: 'Mona Sans'">
